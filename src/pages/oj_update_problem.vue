...
padding-right: 23px;padding-bottom: 23px">
            ...
            <div class="col-md-3 col-md-offset-9">
              <button type="submit" class="btn btn-primary " style="margin-bottom: 20px; margin-top: 20px;" @click="updateProblem">更新题目</button>
...
<script>
  ...
  import {updateProblem,getProblemTag,getDetailProblem2} from "../api/api";
  ...
  export default {
    ...
    methods:{
      ...
      getProblemInfo(){
        getDetailProblem2(this.$route.params.id).then((response)=>{
          this.newproblem = response.data;
        }).catch(function (error) {
          console.log(error.response);
        })
      },
      ...
      updateProblem(){
        ...
        updateProblem(this.$route.params.id,this.newproblem).then((response)=>{
          alert('更新成功');
